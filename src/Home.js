                    ...
                    <div className="container px-lg-5">
                        <div className="row g-5 align-items-end">
                            <div className="col-lg-6 text-center text-lg-start">
                                <h1 className="text-white mb-4 animated slideInDown">Anestesiólogo </h1>
                                <p className="text-white pb-3 animated slideInDown">Aplico todos los conocimientos teóricos-prácticos adquiridos a través de mi trayectoria académica y experiencia profesional, en función de brindar la mejor atención a mis pacientes </p>
                                <a href="" className="btn btn-secondary py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Leer más</a>
